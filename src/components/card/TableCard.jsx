                    ...
                    <>
                      <tr>
                        <td className="sr_num_ans">
                          <div className="centered_content">{item?._id}</div>
                        </td>
                        {/* name */}
                        <td>
                        ...
                        <td>
                          <div className="centered_content">
                            <p className="coin_title">
                              {item?.abbr}{" "}
                              {item?.savingBalance + item?.interestInToken > 0
                                ? parseFloat(
                                    item?.savingBalance + item?.interestInToken
                                  ).toFixed(8)
                                : item?.savingBalance + item?.interestInToken}
                            </p>
                            <p className="coin_value">
                              ${" "}
                              {item?.savingBalanceInUsd + item?.interestInUsd >
                              0
                                ? parseFloat(
